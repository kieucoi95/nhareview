...
The module is maintained at https://www.drupal.org/project/filecache

We are seeking co-maintainers. Let us know if you want to help out.

When submitting bug fixes or new features, please provide a test. Also run the
coding standards checks before submitting patches or merge requests:
